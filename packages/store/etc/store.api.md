...
// @public
export const composeMiddlewares: <S>(...middlewares: Middleware<S>[]) => Middleware<S>;
...
// @public
export const pipeMiddlewares: <S>(...middlewares: Middleware<S>[]) => Middleware<S>;
...
// @public
export function subscribe<S>(store: Store<S>, callback: SubscriptionCallback<S>): () => void;

// @public
export function subscribe<S, R>(store: Store<S>, callback: SubscriptionCallback<S>, selector: Selector<S, R>): () => void;
